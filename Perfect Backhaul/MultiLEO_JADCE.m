function [H_hat_final, est_idx_final,est_idx_final_0] = MultiLEO_JADCE(ce_choice,ob_nIBI,Phi,Nvar,Agc, ...
    H_true,Act_true,ch,leo,user,ob,ch_para)
...
%             nmse2 = ( norm(H_hat_refined-H_true(:,:,np),'fro') / norm(H_true(:,:,np),'fro') )^2
    ...
    case 'Perfect-CIR'
        ...
        est_idx_final_0 = repmat(Act_true,[1,N_p]);
