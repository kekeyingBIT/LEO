function [Rec_sym] = QVBSSD_v8(Y_quant,Y_low,Y_up,H,nvar,M_ord,Data_mod,R_rec,Fo_DFT)
...
% 2022.7.21 v7, modify the prior of xf to Gaussian distribution (module 0), failed
% 2022.7.21 v8, modify v6 to fully low-resolution case, verify if mixed
% resolution can help to improve the performance
...
%         end  % subcarrier end
        ...
        for u = 1:Nu
            ...
            x_m_sc = q_xt*B_set;       % not right
            x_v_sc =q_xt*abs(B_set).^2;
            p_xt(:,:,u) = q_xt;
            xt_m(:,u) = x_m_sc;  % forgottn
